...
return [
    ...
    'title' => 'Salus AI Health Assistant API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST pour le suivi des symptomes, la prise de rendez-vous et les conseils de bien-etre par IA.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Cette documentation presente les endpoints pour l'authentification, la gestion des symptomes,
            les rendez-vous medicaux, ainsi que les conseils IA.
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Utilisez le header Authorization avec le format: Bearer {token}.',
    ],
