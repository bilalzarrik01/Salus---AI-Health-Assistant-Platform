...
<head>
    ...
    <title>Salus AI Health Assistant API</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-doctors">GET api/doctors</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-doctors-search">
                                <a href="#endpoints-GETapi-doctors-search">GET api/doctors/search</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-me">GET api/me</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-symptoms">
                                <a href="#endpoints-GETapi-symptoms">GET api/symptoms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-symptoms">
                                <a href="#endpoints-POSTapi-symptoms">POST api/symptoms</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-symptoms--id-">
                                <a href="#endpoints-GETapi-symptoms--id-">GET api/symptoms/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-symptoms--id-">
                                <a href="#endpoints-PUTapi-symptoms--id-">PUT api/symptoms/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-symptoms--id-">
                                <a href="#endpoints-DELETEapi-symptoms--id-">DELETE api/symptoms/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-appointments--id-">GET api/appointments/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-appointments--id-">
                                <a href="#endpoints-PUTapi-appointments--id-">PUT api/appointments/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-appointments--id-">
                                <a href="#endpoints-DELETEapi-appointments--id-">DELETE api/appointments/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ai-health-advice">
                                <a href="#endpoints-GETapi-ai-health-advice">GET api/ai/health-advice</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-ai-health-advice">
                                <a href="#endpoints-POSTapi-ai-health-advice">POST api/ai/health-advice</a>
                            </li>
...
<p>API REST pour le suivi des symptomes, la prise de rendez-vous et les conseils de bien-etre par IA.</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost</code>
</aside>
<pre><code>Cette documentation presente les endpoints pour l'authentification, la gestion des symptomes,
les rendez-vous medicaux, ainsi que les conseils IA.</code></pre>
...
<p>Utilisez le header Authorization avec le format: Bearer {token}.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-doctors-search">GET api/doctors/search</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/doctors/search" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"specialty\": \"b\",
...
<code class="language-json" style="max-height: 300px;">{
    &quot;success&quot;: true,
    &quot;data&quot;: [],
    &quot;message&quot;: &quot;Resultats de recherche&quot;
}</code>
 </pre>
    </span>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="specialty"                data-endpoint="GETapi-doctors-search"
               value="b"
               data-component="body">
    <br>
<p>This field is required when <code>city</code> is not present. Must not be greater than 255 characters. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="city"                data-endpoint="GETapi-doctors-search"
               value="n"
               data-component="body">
    <br>
<p>This field is required when <code>specialty</code> is not present. Must not be greater than 255 characters. Example: <code>n</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/doctors/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the doctor. Example: <code>16</code></p>
            </div>
                    </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-symptoms">GET api/symptoms</h2>
...
<span id="example-requests-GETapi-symptoms">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/symptoms" \
    --header "Authorization: Bearer Bearer {token}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-symptoms">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-symptoms" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-symptoms"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-symptoms"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-symptoms" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-symptoms">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-symptoms" data-method="GET"
      data-path="api/symptoms"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-symptoms', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-symptoms"
                    onclick="tryItOut('GETapi-symptoms');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-symptoms"
                    onclick="cancelTryOut('GETapi-symptoms');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-symptoms"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-symptoms"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-symptoms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-symptoms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-symptoms">POST api/symptoms</h2>
...
<span id="example-requests-POSTapi-symptoms">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    \"date_recorded\": \"2026-03-24T09:47:53\",
    \"notes\": \"architecto\"
}"
</code></pre></div>
...
<span id="example-responses-POSTapi-symptoms">
</span>
<span id="execution-results-POSTapi-symptoms" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-symptoms"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-symptoms"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-symptoms" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-symptoms">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-symptoms" data-method="POST"
      data-path="api/symptoms"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-symptoms', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-symptoms"
                    onclick="tryItOut('POSTapi-symptoms');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-symptoms"
                    onclick="cancelTryOut('POSTapi-symptoms');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-symptoms"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-symptoms"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-symptoms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-symptoms"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-symptoms"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="severity"                data-endpoint="POSTapi-symptoms"
               value="mild"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-symptoms"
...
<p>Example: <code>Eius et animi quos velit et.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>date_recorded</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_recorded"                data-endpoint="POSTapi-symptoms"
               value="2026-03-24T09:47:53"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-24T09:47:53</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-symptoms"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-symptoms--id-">GET api/symptoms/{id}</h2>
...
<span id="example-requests-GETapi-symptoms--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/symptoms/16" \
    --header "Authorization: Bearer Bearer {token}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/symptoms/16"
);
...
<span id="example-responses-GETapi-symptoms--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-symptoms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-symptoms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-symptoms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-symptoms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-symptoms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-symptoms--id-" data-method="GET"
      data-path="api/symptoms/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-symptoms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-symptoms--id-"
                    onclick="tryItOut('GETapi-symptoms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-symptoms--id-"
                    onclick="cancelTryOut('GETapi-symptoms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-symptoms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-symptoms--id-"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-symptoms--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the symptom. Example: <code>16</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-symptoms--id-">PUT api/symptoms/{id}</h2>
...
<span id="example-requests-PUTapi-symptoms--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-symptoms--id-">
</span>
<span id="execution-results-PUTapi-symptoms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-symptoms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-symptoms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-symptoms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-symptoms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-symptoms--id-" data-method="PUT"
      data-path="api/symptoms/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-symptoms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-symptoms--id-"
                    onclick="tryItOut('PUTapi-symptoms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-symptoms--id-"
                    onclick="cancelTryOut('PUTapi-symptoms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-symptoms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-symptoms--id-"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-symptoms--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the symptom. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-symptoms--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="severity"                data-endpoint="PUTapi-symptoms--id-"
               value="mild"
               data-component="body">
    <br>
<p>Example: <code>mild</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-symptoms--id-"
               value="Eius et animi quos velit et."
               data-component="body">
    <br>
<p>Example: <code>Eius et animi quos velit et.</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_recorded"                data-endpoint="PUTapi-symptoms--id-"
               value="2026-03-24T09:47:53"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-24T09:47:53</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="PUTapi-symptoms--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-symptoms--id-">DELETE api/symptoms/{id}</h2>
...
<span id="example-requests-DELETEapi-symptoms--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-symptoms--id-">
</span>
<span id="execution-results-DELETEapi-symptoms--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-symptoms--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-symptoms--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-symptoms--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-symptoms--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-symptoms--id-" data-method="DELETE"
      data-path="api/symptoms/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-symptoms--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-symptoms--id-"
                    onclick="tryItOut('DELETEapi-symptoms--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-symptoms--id-"
                    onclick="cancelTryOut('DELETEapi-symptoms--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-symptoms--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-symptoms--id-"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-symptoms--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-symptoms--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the symptom. Example: <code>16</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>now</code>. Example: <code>2052-04-16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>notes</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>The ID of the appointment. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-appointments--id-">PUT api/appointments/{id}</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-appointments--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the appointment. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="doctor_id"                data-endpoint="PUTapi-appointments--id-"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the doctors table. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="appointment_date"                data-endpoint="PUTapi-appointments--id-"
               value="2052-04-16"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>now</code>. Example: <code>2052-04-16</code></p>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-appointments--id-">DELETE api/appointments/{id}</h2>
...
<p>The ID of the appointment. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ai-health-advice">GET api/ai/health-advice</h2>
...
<span id="example-requests-GETapi-ai-health-advice">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/ai/health-advice" \
    --header "Authorization: Bearer Bearer {token}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/ai/health-advice"
);
...
<span id="example-responses-GETapi-ai-health-advice">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-ai-health-advice" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ai-health-advice"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ai-health-advice"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ai-health-advice" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ai-health-advice">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ai-health-advice" data-method="GET"
      data-path="api/ai/health-advice"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ai-health-advice', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ai-health-advice"
                    onclick="tryItOut('GETapi-ai-health-advice');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ai-health-advice"
                    onclick="cancelTryOut('GETapi-ai-health-advice');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ai-health-advice"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/ai/health-advice</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-ai-health-advice"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ai-health-advice"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ai-health-advice"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-ai-health-advice">POST api/ai/health-advice</h2>
...
<span id="example-requests-POSTapi-ai-health-advice">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-ai-health-advice">
</span>
<span id="execution-results-POSTapi-ai-health-advice" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-ai-health-advice"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-ai-health-advice"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-ai-health-advice" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-ai-health-advice">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-ai-health-advice" data-method="POST"
      data-path="api/ai/health-advice"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-ai-health-advice', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-ai-health-advice"
                    onclick="tryItOut('POSTapi-ai-health-advice');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-ai-health-advice"
                    onclick="cancelTryOut('POSTapi-ai-health-advice');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-ai-health-advice"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-ai-health-advice"
               value="Bearer Bearer {token}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {token}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-ai-health-advice"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-ai-health-advice"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="days"                data-endpoint="POSTapi-ai-health-advice"
               value="1"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="limit"                data-endpoint="POSTapi-ai-health-advice"
               value="22"
               data-component="body">
    <br>
